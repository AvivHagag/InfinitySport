...
interface GymBarbellComponentProps {
  GymBarbellProducts: Product[];
}

export default function GymBarbellComponent({
  GymBarbellProducts,
}: GymBarbellComponentProps) {
  const [sortedProducts, setSortedProducts] =
    useState<Product[]>(GymBarbellProducts);
  return (
    <>
      <div className="flex flex-col sm:flex-row justify-between">
        <div className="p-2 flex text-sm sm:text-base text-gray-500 space-x-1">
          ...
          <p>/</p>
          <Link
            href="/dumbbells&bars/gymbarbell"
      ...
      <div className="flex flex-col sm:flex-row w-full">
        ...
        <div className="flex flex-grow">
          {sortedProducts ? (
            <ProductsList GymBarbellProducts={sortedProducts} />
          ) : (
