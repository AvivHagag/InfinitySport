...
export default function FilterComponent({
  ...
  const [SelectHandWeights, setSelectHandWeights] = useState<boolean>(false);
  const [SelectAnkleWeights, setSelectAnkleWeights] = useState<boolean>(false);
  const [SelectPlateWeights, setSelectPlateWeights] = useState<boolean>(false);
  const [SelectGymBarbell, setSelectGymBarbell] = useState<boolean>(false);
  const [SelectKettlebellWeights, setSelectKettlebellWeights] =
    ...
    <>
      ...
      >
        <FilterByComponent
          ...
          SelectHandWeights={SelectHandWeights}
          setSelectHandWeights={setSelectHandWeights}
          SelectPlateWeights={SelectPlateWeights}
          setSelectPlateWeights={setSelectPlateWeights}
          SelectAnkleWeights={SelectAnkleWeights}
          setSelectAnkleWeights={setSelectAnkleWeights}
          SelectKettlebellWeights={SelectKettlebellWeights}
          setSelectKettlebellWeights={setSelectKettlebellWeights}
          SelectGymBarbell={SelectGymBarbell}
          setSelectGymBarbell={setSelectGymBarbell}
          onSale={onSale}
