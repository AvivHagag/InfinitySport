...
interface DumbbellsAndBarsComponentProps {
  dumbbellsAndBarsProducts: Product[];
}

export default function DumbbellsAndBarsComponent({
  dumbbellsAndBarsProducts,
}: DumbbellsAndBarsComponentProps) {
    ...
    <>
      ...
      <div className="flex flex-col sm:flex-row w-full">
        ...
        <div className="flex flex-grow">
          {sortedProducts ? (
            <ProductsList dumbbellsAndBarsProducts={sortedProducts} />
          ) : (
