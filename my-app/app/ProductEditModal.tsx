...
export default function ProductEditModal({
  ...
  const [onSale, setOnSale] = React.useState(product.onSale);
      ...
      <div className="relative top-20 mx-auto p-1 border shadow-lg w-4/5 sm:w-3/4 rounded-xl bg-white dark:bg-slate-950">
        ...
        {isLoading ? (
          <div className="flex flex-col justify-center items-center py-8">
            ...
            <p className="text-lg mt-4 text-gray-600">Updating ...</p>
          </div>
        ) : (
          <div>
            <form
            ...
            >
              ...
              <div className="flex flex-col mb-4 space-y-2">
                ...
                <div className="flex flex-col">
                  ...
                  />
                  {ErrorSize ? (
                    <p className="text-sm text-red-600">Insert currect size</p>
                  ) : null}
                </div>
                <div className="flex flex-col sm:flex-row sm:justify-between sm:space-x-2">
                  <div className="flex flex-col">
