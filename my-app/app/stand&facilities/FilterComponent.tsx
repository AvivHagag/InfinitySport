...
export default function FilterComponent({
  ...
  const [SelectDumbbellRack, setSelectDumbbellRack] = useState<boolean>(false);
  const [SelectStandsAndRacks, setSelectStandsAndRacks] =
    useState<boolean>(false);
  const [SelectStorageFacilities, setSelectStorageFacilities] =
    useState<boolean>(false);
    ...
    <>
      ...
      >
        <FilterByComponent
          ...
          SelectDumbbellRack={SelectDumbbellRack}
          setSelectDumbbellRack={setSelectDumbbellRack}
          SelectStorageFacilities={SelectStorageFacilities}
          setSelectStorageFacilities={setSelectStorageFacilities}
          SelectStandsAndRacks={SelectStandsAndRacks}
          setSelectStandsAndRacks={setSelectStandsAndRacks}
          onSale={onSale}
