...
interface StandAndFacilitiesComponentProps {
  StandAndFacilitiesProducts: Product[];
}

export default function StandAndFacilitiesComponent({
  StandAndFacilitiesProducts,
}: StandAndFacilitiesComponentProps) {
    ...
    <>
      ...
      <div className="flex flex-col sm:flex-row w-full">
        ...
        <div className="flex flex-grow">
          {sortedProducts ? (
            <ProductsList StandAndFacilitiesProducts={sortedProducts} />
          ) : (
