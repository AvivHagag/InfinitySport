...
interface ExerciseBikeComponentProps {
  ExercisebikeProducts: Product[];
}

export default function ExerciseBikeComponent({
  ExercisebikeProducts,
}: ExerciseBikeComponentProps) {
  const [sortedProducts, setSortedProducts] =
    useState<Product[]>(ExercisebikeProducts);
  return (
    <>
      <div className="flex flex-col sm:flex-row justify-between">
        <div className="p-2 flex text-sm sm:text-base text-gray-500 space-x-1">
          ...
          <p>/</p>
          <Link
            href="/homefitnessequipment/exercisebike"
      ...
      <div className="flex flex-col sm:flex-row w-full">
        ...
        <div className="flex flex-grow">
          {sortedProducts ? (
            <ProductsList ExercisebikeProducts={sortedProducts} />
          ) : (
